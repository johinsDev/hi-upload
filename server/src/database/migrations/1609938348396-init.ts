...
export class init1609938348396 implements MigrationInterface {
    name = 'init1609938348396'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "subscription_usage" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "valid_until" TIMESTAMP, "used" bigint NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "update_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "subscription_id" uuid, "features_id" uuid, CONSTRAINT "PK_6cca9752b083ee0533770af8121" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "plan_features" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "slug" character varying NOT NULL, "name" character varying NOT NULL, "description" character varying NOT NULL, "value" bigint NOT NULL, "resettable_interval" character varying NOT NULL DEFAULT 'month', "resettable_period" smallint NOT NULL DEFAULT '0', "sort_order" integer NOT NULL DEFAULT '0', "created_at" TIMESTAMP NOT NULL DEFAULT now(), "update_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, CONSTRAINT "UQ_65d9d67a4a48d135976227c89ac" UNIQUE ("slug"), CONSTRAINT "PK_eb2b32d1d93a8b2e96e122e3a77" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "plan_features_plans_plan" ("plan_features_id" uuid NOT NULL, "plan_id" uuid NOT NULL, CONSTRAINT "PK_5dd64214ee539f66ba161927569" PRIMARY KEY ("plan_features_id", "plan_id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_7adc4049a6b084a15e63ad61e3" ON "plan_features_plans_plan" ("plan_features_id") `);
        await queryRunner.query(`CREATE INDEX "IDX_f13aa3a5f6b771eafb26656161" ON "plan_features_plans_plan" ("plan_id") `);
        ...
        await queryRunner.query(`ALTER TABLE "subscription_usage" ADD CONSTRAINT "FK_202ea1c204af27272b88c5fe98a" FOREIGN KEY ("features_id") REFERENCES "plan_features"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        ...
        await queryRunner.query(`ALTER TABLE "plan_features_plans_plan" ADD CONSTRAINT "FK_7adc4049a6b084a15e63ad61e36" FOREIGN KEY ("plan_features_id") REFERENCES "plan_features"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "plan_features_plans_plan" ADD CONSTRAINT "FK_f13aa3a5f6b771eafb266561619" FOREIGN KEY ("plan_id") REFERENCES "plan"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "plan_features_plans_plan" DROP CONSTRAINT "FK_f13aa3a5f6b771eafb266561619"`);
        await queryRunner.query(`ALTER TABLE "plan_features_plans_plan" DROP CONSTRAINT "FK_7adc4049a6b084a15e63ad61e36"`);
        ...
        await queryRunner.query(`ALTER TABLE "subscription_usage" DROP CONSTRAINT "FK_202ea1c204af27272b88c5fe98a"`);
        ...
        await queryRunner.query(`DROP INDEX "IDX_f13aa3a5f6b771eafb26656161"`);
        await queryRunner.query(`DROP INDEX "IDX_7adc4049a6b084a15e63ad61e3"`);
        await queryRunner.query(`DROP TABLE "plan_features_plans_plan"`);
